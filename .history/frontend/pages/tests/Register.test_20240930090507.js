...
describe('Register Component', () => {
  ...
  it('should display an error when registration fails', async () => {
    ...
    await screen.findByText('Registration failed, username has been used'); // Ensuring the alert text is displayed
  ...
  it('should redirect after successful registration', async () => {
    ...
    await screen.findByText('Registration successful! You can now log in.'); // Ensuring the success message is displayed
    expect(mockPush).toHaveBeenCalledWith('/login'); // Verifying that the router push happened
  });
